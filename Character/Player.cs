...
namespace RPGFramework
{
    internal partial class Player : Character
    {
        ...
        [
            ...
            new() {RequiredXp = 9000, StatPoints = 1, Health = 25, Mana = 15},
            new() {RequiredXp = 9500, StatPoints = 1, Health = 25, Mana = 15},
            new() {RequiredXp = 10000, StatPoints = 1, Health = 25, Mana = 15},
            new() {RequiredXp = 10500, StatPoints = 1, Health = 25, Mana = 15},
            new() {RequiredXp = 11000, StatPoints = 1, Health = 25, Mana = 15},
            new() {RequiredXp = 11500, StatPoints = 1, Health = 25, Mana = 15},
            new() {RequiredXp = 12000, StatPoints = 1, Health = 25, Mana = 15},
            new() {RequiredXp = 12500, StatPoints = 1, Health = 25, Mana = 15},
            new() {RequiredXp = 13000, StatPoints = 1, Health = 25, Mana = 15}
        ];
